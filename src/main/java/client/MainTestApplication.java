...
public class MainTestApplication implements AutoCloseable{
    ...
    MainTestApplication(Socket socket) {
        this.socket = socket;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            MainTestApplication mainTestApplication = new MainTestApplication(socket);
            mainTestApplication.start();
        } catch (Exception e) {
            e.printStackTrace();
        }
